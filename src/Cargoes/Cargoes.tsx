...
import ViewCargo from '../Cargoes/ViewCargoes/ViewCargo.tsx';
...
function Cargoes() {
    ...
    const handleViewClick = (cargo: cargo) => {
        setSelectedCargo(cargo);
        setIsViewing(true);
    }
    ...
    return (
        <div>
            {isEditing && selectedCargo ?
                ...
                isViewing && selectedCargo ?
                (
                    <ViewCargo cargo={selectedCargo} onClose={handleCloseView} />
                ) :
                (
                    <div className="cargoes_main_div">
                        ...
                        <div className='cargoes_outlet_div'>
                            <Outlet context={{onEditClick: handleEditClick,onViewClick:handleViewClick}} />
                        </div>
                    </div>
                )
            }
